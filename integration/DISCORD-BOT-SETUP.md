...
REPORT_CHANNEL_ID=...
PGSKO_DISCORD_ENABLED=false # ПГСкО остаётся только на портале
PGSKO_REPORT_CHANNEL_ID=
ACT_REVIEW_CHANNEL_ID=...
DISCIPLINE_CHANNEL_ID=...
KSO_TASKS_CHANNEL_ID=...    # только для BOT_UNIT=ca; у Арбата пусто
CASES_CHANNEL_ID=...
ROSTER_CHANNEL_ID=...
PGSKO_APPROVER_ROLE_ID=     # не используется, пока PGSKO_DISCORD_ENABLED=false
