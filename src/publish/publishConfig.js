...
// === СОСТАВ (фича А) ===
// Заголовки секций по отделам.
export const ROSTER_SECTIONS = [
  { department: "Аппарат руководителя ГСУ СК России", header: "🇷🇺 | Аппарат руководителя ГСУ СК России:" },
  { department: "Следственный отдел (СО)", header: "⭐ | Следственный отдел (СО):" },
  { department: "Отдел профессиональной подготовки (ОПП)", header: "🎓 | Отдел профессиональной подготовки (ОПП):" },
];
